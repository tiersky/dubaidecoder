...
export const countryCodeMap: Record<string, string> = {
  ru: 'RUS', de: 'DEU', sa: 'SAU', pl: 'POL', it: 'ITA', gb: 'GBR',
  us: 'USA', fr: 'FRA', cz: 'CZE', cn: 'CHN', nl: 'NLD', tr: 'TUR',
  ro: 'ROU', jo: 'JOR', kz: 'KAZ', kw: 'KWT', es: 'ESP', at: 'AUT',
  be: 'BEL', ch: 'CHE', in: 'IND', sk: 'SVK', by: 'BLR', ca: 'CAN',
  jp: 'JPN',
};
